...
// ------------------------------------
// This header defines the Options class or struct used to hold all configurable
// runtime parameters for the SimForager simulation. It also includes logic to
// parse and validate command-line arguments (via CLI11), load config files,
// and provide default fallbacks for all simulation parameters.
//
// This file must not alter internal logic from its original version.
// Only comments are added for documentation purposes.
